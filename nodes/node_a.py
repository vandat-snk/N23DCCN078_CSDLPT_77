# nodes/node_a.py - Node A: Dữ liệu CNTT (cổng 5001)
...
NODE_ID = "A"
PORT = 5001
DATA_FILE = os.path.join(os.path.dirname(__file__), "..", "data", "node_a_cntt.json")
...
if __name__ == "__main__":
    print(f"🟢 Node {NODE_ID} (CNTT) đang chạy trên cổng {PORT}...")
