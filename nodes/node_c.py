# nodes/node_c.py - Node C: Dữ liệu Y tế (cổng 5003)
...
NODE_ID = "C"
PORT = 5003
DATA_FILE = os.path.join(os.path.dirname(__file__), "..", "data", "node_c_y_te.json")
...
if __name__ == "__main__":
    print(f"🟢 Node {NODE_ID} (Y tế) đang chạy trên cổng {PORT}...")
